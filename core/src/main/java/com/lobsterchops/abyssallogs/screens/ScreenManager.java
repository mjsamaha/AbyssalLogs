    ...
    private class TransitionScreen implements Screen {
        ...
        private void renderFadeTransition(float progress) {
            ...
            if (progress < 1f) {
                ...
                // Render the from screen normally (it handles its own batch)
            ...
            // Render the to screen normally (it handles its own batch)
            toScreen.render(Gdx.graphics.getDeltaTime());

            // Reset batch color and disable blending
        ...
        private void completeTransition() {
            ...
            fromScreen.hide();
            fromScreen.dispose(); // Dispose the old screen to free resources
